...
function Page() {
  ...
  if (status === 'error') {
    return (
      <>
        <h1 className="mb-4 text-2xl font-semibold tracking-tight text-white">Air Combat Lineup</h1>
        <div className="mx-auto max-w-[1400px]">
          <div className="mb-3 rounded-xl border border-amber-400/50 bg-amber-400/10 px-3 py-2.5 text-[14px] text-amber-200">
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1400px]">
        ...
        {message && (
          <div className="glass mb-3 flex items-center gap-3 px-3 py-2.5 text-[14px]">
            {message}

...
public class SparkJob implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        try {
            ...
            SparkLauncher sparkLauncher = new SparkLauncher().setAppResource(map.getString("path")).
                    setMainClass(map.getString("className")).setMaster(map.getString("master")).
                    setSparkHome(sparkHome).setDeployMode(map.getString("deployMode"));
            ...
            if (map.get("sparkArg") == null) {
                appArgList = (List<String>) map.get("appArg");
            }
            ...
            appLogger.info("Task started, run main class: " + map.getString("className"));
